...
namespace YZPortal.Core.Indexes
{
    ...
    public static class SearchExtensions
    {
        ...
        public static async Task<SearchList<TEntity>> CreateSearchListAsync<TEntity>(this List<TEntity> list, ISearchParams searchParams, System.Linq.Expressions.Expression<Func<TEntity, bool>>? searchPredicate = null, CancellationToken cancellationToken = new CancellationToken()) where TEntity : class
        {
            #region Query formulation
            ...
            var valiedProperties = typeof(TEntity).GetProperties().Select(x => x.Name.ToLower());
